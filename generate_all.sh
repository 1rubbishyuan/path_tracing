...
build/PA1 testcases/A_fieldDepth.txt output/A_fieldDepth0.bmp
build/PA1 testcases/A_fa.txt output/A_fa0.bmp
build/PA1 testcases/A_move.txt output/A_move0.bmp
build/PA1 testcases/A_fa.txt output/A_fa0.bmp
build/PA1 testcases/A_normal.txt output/A_normal0.bmp
build/PA1 testcases/A_curve.txt output/A_curve0.bmp
build/PA1 testcases/A_rabbit.txt output/A_rabbit0.bmp